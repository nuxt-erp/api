...
class ProductLogController extends ControllerService
{
    ...
    public function getLog(Request $request) {
        ...
        // sendFullCollectionResponse it's important to return total of records (useful for pagination)
        return $this->sendFullCollectionResponse($itens, ProductLogResource::class);
    }
}
